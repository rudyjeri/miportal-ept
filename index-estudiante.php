  ...
  font-size: 13px;
      ...
      <div class="content-sections">
        ...
        <div class="container">
          ...
          <div class="courses">
            <a href="ept-estudiante.php" class="course-card">
            ...
            <a href="curso2.html" class="course-card">
              <img src="images/IMG_20240410_104714.jpg" alt="Curso 2">
              <h3>Matemática </h3>
              <p></p>
        ...
        <aside class="activities">
          ...
          <ul>
            <li>
              ...
              <span>  Educación para el Trabajo EPT .</span>
